...
export default function IsCompleteButton({
  ...
  const iconSvg = (isComplete: string) => {
    if (isComplete === "start") {
      return (
        <>
          <svg
          ...
          <span className="text-xs text-neutral-400">시작하기</span>
        </>
      );
      ...
      return (
        <>
          ...
          <span className="text-xs text-neutral-400">대기중</span>
        </>
      );
      ...
      return (
        <>
          ...
          <span className="text-xs text-blue-400">진행중</span>
        </>
      );
    } else {
      return (
  ...
  return (
    <button className="rounded-3xl border px-2 py-1 flex gap-1 justify-center items-center">
      {iconSvg(isComplete)}
    </button>
  );
}
